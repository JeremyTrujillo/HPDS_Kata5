...
public class SimpleViewPoint implements ViewPoint {
    ...
    public SimpleViewPoint(String facing, int x, int y) { this(Heading.of(facing),new Position(x,y)); }

    public SimpleViewPoint(Heading heading, int x, int y) { this(heading, new Position(x,y)); }
    ...
    public static class Position {
        ...
        private Position forwardPosition(Heading heading) { return new Position(this.x + dx(heading), this.y + dy(heading)); }
        ...
        @Override
        public boolean equals(Object object) { return isSameClass(object) && equals((Position) object); }
