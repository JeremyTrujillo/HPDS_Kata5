...
public class Rover {
	...
	public void go(String instructions){ set(go(stream(instructions.split("")).map(Order::of))); }

	public void go(Order... orders){ set(go(stream(orders))); }
	...
	@FunctionalInterface
	public interface Action { ViewPoint execute(ViewPoint viewPoint);}
}